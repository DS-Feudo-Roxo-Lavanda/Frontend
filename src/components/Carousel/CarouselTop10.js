    ...
    return(
        <div className='container'>
            ...
            {data.map((show) => {
                ...
                return(
                    <div className="top10-show" key={id} onClick={() => navigate('/Details', {state: {id: id, title: title, poster: poster_path, overview: overview, date: release_date, vote: vote_average}})}>
                        <img ></img>
